package com.example.keycloak_spring_unit1.keycloakclient;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import com.example.keycloak_spring_unit1.dto.Role;
import com.example.keycloak_spring_unit1.dto.User;
import com.example.keycloak_spring_unit1.security.KeycloakSecurityUtil;
...
public class UserResource {
    ...
    public Response createRole(@PathVariable("id") String id,
        ...
        log.info("{}",  mapUser(keycloak.realm(realm).users().get(id).toRepresentation()));
        log.info("{}",  RoleResource.mapRole(role));
        return Response.ok().build();
    }
